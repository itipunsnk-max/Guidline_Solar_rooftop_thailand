...
> ฉบับเรียบเรียงใหม่พร้อมลิงก์อ้างอิงจริง  
> วันที่จัดทำใหม่: 15 กรกฎาคม 2569  
> หมายเหตุ: ตัวเลขทางวิศวกรรมและการเงินที่ระบุว่าเป็น “สมมติฐาน” ยังต้องยืนยันด้วยข้อมูลโครงการจริง
...
หมายเหตุ: ตารางนี้เป็น **ตัวอย่างเชิงแบบจำลอง** เพื่อใช้คุยกับผู้บริหารเมื่อยังไม่มีข้อมูลจริงครบ ไม่ใช่ข้อเสนอราคาหรือการรับประกันผลผลิตจริง ตัวเลขใช้วิธีคิดตามกรอบ PVsyst/NPV/LCOE มาตรฐานงาน PV และสมมติฐานทางธุรกิจที่ต้องยืนยันอีกครั้งด้วยบิลไฟฟ้า โหลดโปรไฟล์ และใบเสนอราคาจริง [[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)[[10]](https://www.nrel.gov/pv/lcoe-calculator/documentation.html)

ข้อเสนอเพื่อขออนุมัติในรอบนี้จึงควรเป็นการขออนุมัติ **งบศึกษาและออกแบบละเอียด** มากกว่างบ EPC เต็มจำนวน โดยให้อนุมัติ 3 เรื่องพร้อมกัน คือ การเก็บข้อมูลโหลดไฟและเอกสารระบบเดิม การสำรวจโครงสร้าง/หลังคา/ไฟฟ้า และการทำ preliminary interconnection check กับการไฟฟ้า หากขั้นตอนนี้ผ่าน จึงค่อยสรุปขนาดระบบ ข้อกำหนดอุปกรณ์ และงบลงทุนที่เชื่อถือได้ในระดับ Preliminary หรือ Detailed estimate ต่อไป [[4]](https://ppim.pea.co.th/)[[11]](https://ppim.pea.co.th/app/v1/project/list)[[12]](https://www.pea.co.th/business-partner/produt-acceptance)[[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)

## กรอบโครงการ ข้อมูลตั้งต้น และข้อมูลที่ยังขาด

เอกสาร brief ระบุขอบเขตที่ต้องการไว้อย่างละเอียดมาก ทั้งในด้านวิศวกรรม โครงสร้าง ระบบไฟฟ้า ความปลอดภัย การเงิน ใบอนุญาต มาตรฐาน และเอกสารสำหรับเสนอผู้บริหาร แต่ยังไม่ได้ให้ข้อมูลโครงการจริงที่จำเป็นต่อการตัดสินใจ เช่น ชื่อโครงการ สถานที่ ประเภทมิเตอร์/การไฟฟ้า ประเภทโหลด พื้นที่หลังคาใช้การได้จริง ข้อจำกัดการหยุดจ่ายไฟ และข้อมูล BESS ดังนั้นขั้นตอนแรกของผู้ว่าจ้างควรเป็นการ “แปลง TOR ให้เป็น Data Package” ก่อน [1]

### ข้อมูลที่ทราบแล้วและยังไม่ทราบ

| หมวด | สถานะ | สิ่งที่ทราบ | สิ่งที่ยังไม่ทราบ |
|---|---|---|---|
| วัตถุประสงค์ | ทราบ | ต้องการประเมินเทคนิค การเงิน ใบอนุญาต Proposal และงบลงทุน [1] | เกณฑ์ Go/No-Go ที่ผู้บริหารใช้จริง เช่น payback target หรือ IRR hurdle rate |
| รูปแบบโครงการ | ยังไม่ชัด | พิจารณาได้ทั้ง self-consumption, ขายไฟ, PPA, CAPEX, ESCO [1] | ต้องการโมเดลใดเป็นหลัก |
| พื้นที่ติดตั้ง | ยังไม่ชัด | เป็น Solar Rooftop ในประเทศไทย [1] | จังหวัด พิกัด ระดับความสูง สิ่งกีดขวาง สภาพแวดล้อม |
| ไฟฟ้าเดิม | ยังไม่ชัด | ต้องตรวจหม้อแปลง MDB SLD protection earthing ฯลฯ [1] | แรงดัน ระบบสาย ขนาดหม้อแปลง fault level จุดเชื่อมต่อจริง |
| โหลดไฟฟ้า | ยังไม่ชัด | ต้องมีบิล 12–24 เดือน และโหลด 15 นาที/รายชั่วโมง [1] | load shape กลางวัน/กลางคืน, demand pattern, วันหยุด |
| โครงสร้าง | ยังไม่ชัด | ต้องตรวจแบบโครงสร้าง อายุหลังคา น้ำรั่ว กัดกร่อน แรงลม ฯลฯ [1] | รับน้ำหนักได้เท่าไร ต้องเสริมหรือไม่ |
| ใบอนุญาต | ยังไม่ชัด | ต้องทำ permit matrix และตรวจ กฟน./กฟภ./กกพ./อาคาร/โรงงาน/อัคคีภัย [1] | เคสนี้เข้าข้อยกเว้นหรือไม่ ต้องขออะไรบ้าง |
...
ในทางปฏิบัติ โครงการ Solar Rooftop สำหรับอาคารเชิงพาณิชย์/อุตสาหกรรมไม่ใช่แค่ “เอาพื้นที่หลังคาคูณจำนวนแผง” แต่ต้องทำงานร่วมกัน 5 ระบบพร้อมกัน คือ โหลดไฟฟ้าเดิม โครงสร้างหลังคา ระบบไฟ AC/DC ระบบความปลอดภัย และกรอบการเชื่อมต่อ/ใบอนุญาต หากขาดข้อมูลด้านใดด้านหนึ่ง ผลลัพธ์ทางการเงินจะคลาดเคลื่อนทันที แม้ระบบจะดูคุ้มในระดับพลังงานก็ตาม [[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)[[9]](https://iea-pvps.org/research-tasks/reliability-and-performance-of-pv-systems/)[[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)
...
|---|---|---|---|---|
| ข้อกำหนดการเชื่อมต่อระบบโครงข่ายไฟฟ้า PEA | PEA | **ต้องปฏิบัติ** เมื่ออยู่ในพื้นที่ PEA | หน้าใช้งานปัจจุบัน ณ 15 ก.ค. 2569 [[14]](https://www.pea.co.th/business-partner/regulation)[[16]](https://www.pea.co.th/business-partner/regulation) | ต้องแตกเป็น requirement list ราย protection/metering ก่อนออกแบบละเอียด |
| ระบบ PPIM: ตรวจสอบจุดเชื่อมโยง / ขอเชื่อมต่อ / Solar Rooftop | PEA | **ต้องปฏิบัติ** ตามกรณี | หน้าใช้งานปัจจุบัน ณ 15 ก.ค. 2569 [[4]](https://ppim.pea.co.th/)[[15]](https://ppim.pea.co.th/app/v1/project/solar/list)[[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF) | ใช้กำหนด workflow ยื่นคำขอจริง |
| อัตราค่าไฟฟ้า TOU / Ft / FiTv | PEA และ กกพ. | **ต้องใช้เป็นฐานการเงิน** | TOU page update 23 มิ.ย. 2569; Ft page และ FiTv 2569 แสดงบนหน้า tariff [[3]](https://www.pea.co.th/our-services/tariff)[[17]](https://www.pea.co.th/our-services/tariff/ft) | ค่า tariff ต้องแทนด้วยบิลจริงของไซต์ |
| PEA Product Acceptance / Smart Grid & Renewable equipment registry | PEA | **ต้องตรวจ** ก่อนล็อกสเปกอุปกรณ์ | หน้า Product Acceptance ปัจจุบัน; smartlist ถูกบล็อกใน session อัตโนมัติ [[12]](https://www.pea.co.th/business-partner/produt-acceptance)[[18]](https://smartlist.pea.co.th/) | inverter/relay/metering ต้องยืนยันรายการยอมรับจริงก่อนจัดซื้อ |
| PVsyst 8.1 documentation | PVsyst | **แนวทางแนะนำหลัก** | PVsyst 8.1 [[6]](https://www.pvsyst.com/help/) | ใช้เป็นฐาน simulation และ loss breakdown |
| IEA PVPS Task 13 | IEA PVPS | **แนวทางแนะนำหลัก** | รายงาน มิถุนายน 2026 [[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/) | ใช้กำหนด quality gates, monitoring, O&M, risk approach |
| รายการ IEC/NEC/ไทยที่ผู้ว่าจ้างกำหนดให้ตรวจ เช่น IEC 60364-7-712, IEC 62548, IEC 62446-1, IEC 61730, IEC 61215, IEC 62109, IEC 62116, IEC 61000, IEC 61643-31, IEC 62305, IEC 62930, IEC 62933, IEC 62619, IEC 63056, NEC 690/705/706 | IEC / NFPA / ไทย | **ต้องตรวจยืนยันรายมาตรฐานก่อน IFC และ procurement** | **ยังไม่ยืนยัน Edition รายฉบับในรอบนี้** | รายการนี้มาจาก brief ของผู้ว่าจ้างและควรทำ standards register แยกพร้อม URL ต้นฉบับในรอบถัดไป [1] |

### การแยกชั้นของข้อกำหนด

| ชั้นของข้อกำหนด | ความหมายทางปฏิบัติ | ตัวอย่างในโครงการนี้ |
|---|---|---|
| ข้อบังคับตามกฎหมาย/การอนุญาต | ถ้าไม่ผ่านจะเชื่อมต่อหรือเดินโครงการไม่ได้ | การยื่นคำขอ PEA/MEA, ขั้นตอน กกพ., การอนุญาตดัดแปลงอาคาร/โรงงาน/อัคคีภัย ตามกรณี [[4]](https://ppim.pea.co.th/)[[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF) |
| มาตรฐานที่ต้องปฏิบัติในงานออกแบบ/ทดสอบ | ใช้เป็น design basis และ commissioning basis | utility interconnection requirements, protection, metering, product acceptance, commissioning documents [[14]](https://www.pea.co.th/business-partner/regulation)[[12]](https://www.pea.co.th/business-partner/produt-acceptance) |
| แนวทางแนะนำเชิงวิศวกรรม | ช่วยให้ผลโครงการดีและลดความเสี่ยง | PVsyst simulation method, IEA PVPS quality framework, data-driven O&M, loss analysis [[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)[[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)[[9]](https://iea-pvps.org/research-tasks/reliability-and-performance-of-pv-systems/) |

## วิธีสำรวจหน้างานและแนวทางออกแบบ

การสำรวจที่ดีควรถูกมองเป็น “การปิดความไม่แน่นอน” มากกว่าการ “ถ่ายรูปหลังคาแล้วกลับมาออกแบบ” เพราะข้อผิดพลาดที่แพงที่สุดมักไม่ใช่ราคาแผงหรือ inverter แต่เป็นเรื่องโครงสร้าง น้ำรั่ว เมนบอร์ดเดิมไม่รองรับ การประสาน protection ไม่ผ่าน การหยุดงานของไซต์ และข้อจำกัดเรื่องการเข้าพื้นที่ระหว่างดำเนินธุรกิจจริง [[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)[[9]](https://iea-pvps.org/research-tasks/reliability-and-performance-of-pv-systems/)
...
ตารางนี้สอดคล้องกับรายการใน brief ที่ระบุว่าต้องตรวจบิลค่าไฟ โหลดราย 15 นาที หม้อแปลง MDB SLD แบบหลังคา ข้อจำกัดการเข้าพื้นที่ และผู้มีอำนาจอนุมัติ ก่อนทำการออกแบบจริง [1]
...
เส้นทางนี้สอดคล้องกับสิ่งที่ PPIM ของ PEA แยกออกเป็นขั้นตรวจสอบจุดเชื่อมโยง ขั้นโครงการ rooftop และขั้นคำขอเชื่อมต่อจริง จึงไม่ควรกระโดดจาก site survey ไปจัดซื้ออุปกรณ์ทันทีโดยไม่เคลียร์ interconnection pathway ก่อน [[4]](https://ppim.pea.co.th/)[[11]](https://ppim.pea.co.th/app/v1/project/list)[[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF)

### Design basis เบื้องต้นที่แนะนำ

| ตัวแปรออกแบบ | แนวทางแนะนำเบื้องต้น | ที่มาหรือเหตุผล |
|---|---|---|
| เป้าหมายหลัก | ลดค่าไฟจากการกินไฟเองก่อน | ช่วง Peak ของ TOU อยู่กลางวัน จึงทำให้ self-consumption มีมูลค่าสูง [[2]](https://www.pea.co.th/sites/default/files/documents/tariff/electricity_tariff.pdf) |
| รูปแบบระบบ | Grid-connected rooftop, พิจารณา zero export ถ้า utility/โหลดกำหนด | สอดคล้องกับเส้นทาง self-use ของ PEA [[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF) |
| ขนาดระบบเริ่มต้น | ใช้โหลดกลางวันและหลังคา usable area เป็นตัวกำหนดพร้อมกัน | ลดความเสี่ยง export สูงเกินจำเป็น |
| DC/AC ratio | เริ่มพิจารณาแถว 1.15–1.30 เป็นช่วงศึกษา | เป็นช่วงใช้งานแพร่หลายในงาน PV และสอดคล้องกับ logic ของ PVsyst/NREL สำหรับ commercial systems [[10]](https://www.nrel.gov/pv/lcoe-calculator/documentation.html)[[6]](https://www.pvsyst.com/help/) |
| Loss budget | กำหนด soiling, thermal, mismatch, wiring, transformer, unavailability แยกรายการชัดเจน | PVsyst ระบุให้ตั้งค่าการสูญเสียแต่ละตัวแยกกันและแสดงผลใน loss diagram [[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html) |
| Monitoring | ต้องมี data logger/portal + alarm + monthly KPI review | IEA PVPS เน้น data-driven O&M และ predictive maintenance [[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)[[9]](https://iea-pvps.org/research-tasks/reliability-and-performance-of-pv-systems/) |
| อุปกรณ์ | ต้องยืนยันกับ Product Acceptance / smartlist ก่อนซื้อ | PEA แยกหน้า product acceptance และ registries ไว้เป็นทางการ [[12]](https://www.pea.co.th/business-partner/produt-acceptance)[[18]](https://smartlist.pea.co.th/) |

## แบบจำลองพลังงาน การเงิน และทางเลือกโครงการ

### วิธีจำลองที่ควรใช้

PVsyst 8.1 รองรับการศึกษาแบบ preliminary design ที่ใช้ข้อมูลพื้นที่และพารามิเตอร์ไม่มาก และรองรับ project design แบบจริงที่จำลองรายชั่วโมง/รายย่อย พร้อมกำหนด orientation, component selection, thermal behavior, wiring, mismatch, horizon shading, partial shading, load profile, grid limitation และ transformer losses ได้ครบ ซึ่งเหมาะตรงกับโจทย์ Solar Rooftop C&I ในไทยอย่างมาก [[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)

สำหรับรายงานรอบแรก ควรใช้ลำดับดังนี้  
เริ่มจาก 1) วิเคราะห์บิลและโหลด 2) กำหนดตัวเลือกหลังคา/ทิศ/มุมเอียง 3) ตั้ง loss assumptions อย่างโปร่งใส 4) ตรวจผล specific yield กับฐานข้อมูลรังสีอาทิตย์ของไทย/พื้นที่ใกล้เคียง 5) รัน self-consumption model และ 6) จึงทำ NPV/IRR/LCOE ไม่ควรเริ่มจาก “ตั้งขนาดระบบก่อน” แล้วค่อยหาวิธีทำให้ตัวเลขคุ้ม เพราะจะทำให้ผู้บริหารเห็นผลลวงว่าหลังคาใหญ่ = คุ้มกว่าเสมอ ซึ่งไม่จริงเมื่อ export value ต่ำหรือ zero export ถูกบังคับใช้ [[13]](https://arxiv.org/abs/2409.16320)[[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)[[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)
...
PVsyst ระบุชัดว่าระบบสามารถตั้งค่า losses แยกรายการ เช่น IAM, soiling, irradiance loss, thermal loss, module quality, mismatch, degradation, DC/AC ohmic, transformer loss, auxiliaries และ system unavailability รวมทั้งมีเมนู P50-P90 evaluation สำหรับงานที่ต้องดูความไม่แน่นอนเชิงสถิติด้วย [[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)
...
สำหรับวิธีคิดต้นทุนและ LCOE เอกสารของ NREL อธิบายแยกต้นทุนโมดูล, BOS power-scaling, BOS area-scaling, O&M และ yield อย่างเป็นระบบ ซึ่งเหมาะใช้เป็นกรอบคิดตรวจสอบความสมเหตุสมผลของ financial model แม้สุดท้ายการอนุมัติงบต้องอิงใบเสนอราคาจริงในประเทศไทยก็ตาม [[10]](https://www.nrel.gov/pv/lcoe-calculator/documentation.html)
...
มุมมองที่สำคัญคือ ใน rooftop เชิงพาณิชย์ทั่วไป **ตัวแปรที่แรงที่สุดมักไม่ใช่ degradation** แต่เป็น 1) ค่าไฟที่หลีกเลี่ยงได้จริง 2) self-consumption ratio จริง 3) CAPEX EPC จริง 4) ข้อจำกัด utility/zero export และ 5) โครงสร้างหลังคาที่ต้องเสริมเพิ่มหรือไม่ ดังนั้นการเก็บข้อมูลโหลดและการสำรวจโครงสร้างจึงมัก “มีมูลค่ามากกว่าการต่อรองราคาแผงไม่กี่เปอร์เซ็นต์” หากมองทั้งโครงการ [[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)[[6]](https://www.pvsyst.com/help/)[[7]](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html)
...
|---|---|---|---|---|
| 1 | PEA / MEA | ตรวจสอบจุดเชื่อมต่อ | เมื่อจะต่อขนานกับโครงข่าย | ต้องยื่นเมื่อทราบ utility และ SLD จริง [[4]](https://ppim.pea.co.th/)[[11]](https://ppim.pea.co.th/app/v1/project/list) |
| 2 | PEA / MEA | คำขอเชื่อมต่อกรณีติดตั้งใช้เองไม่ขายไฟ | self-consumption grid-tied | ต้องยืนยันจาก utility area จริง [[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF) |
| 3 | PEA | โครงการ Solar Rooftop ขายไฟส่วนเหลือ | กรณีต้องการขายส่วนเกินในพื้นที่ PEA | เปิดเป็นอีกเส้นทางหนึ่งใน PPIM ปี 2569 [[4]](https://ppim.pea.co.th/)[[15]](https://ppim.pea.co.th/app/v1/project/solar/list) |
| 4 | กกพ. | จดแจ้งยกเว้น/ใบอนุญาตตามกรณี | ขึ้นกับรูปแบบและขนาดโครงการ | ต้องตรวจข้อกฎหมายจริงกับที่ปรึกษาใบอนุญาต; PPIM เชื่อมลิงก์ไปยังระบบ กกพ. [[4]](https://ppim.pea.co.th/) |
...
เพราะเครื่องมือค้นหาในรอบนี้ดึงเอกสารกฎหมายไทยเฉพาะฉบับได้ไม่ครบ และ utility area ยังไม่ทราบ จึงควรถือว่า Permit Matrix ข้างต้นเป็น “เมทริกซ์ใช้งานจริงระดับต้นแบบ” ที่ต้องให้ที่ปรึกษากฎหมาย/ใบอนุญาตและเจ้าของพื้นที่ยืนยันอีกครั้งก่อนออกเอกสารเสนอคณะอนุมัติ [1]
...
| อุปกรณ์ไม่อยู่ใน accepted list | เปลี่ยนสเปกกลางทาง | สูง | ตรวจ PEA/MEA acceptance ก่อนสั่งซื้อ [[12]](https://www.pea.co.th/business-partner/produt-acceptance)[[18]](https://smartlist.pea.co.th/) |
...
| BESS risk ถ้ามี | safety/permit/EMS ซับซ้อนขึ้น | สูง | แยก design review เฉพาะ BESS ตามมาตรฐานที่เกี่ยวข้อง [1] |
...
7. ถ้ามี hazardous area หรือ BESS ต้องแยก HAZID/HAZOP หรือ safety review เฉพาะทางเพิ่ม [[4]](https://ppim.pea.co.th/)[[5]](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF)[[12]](https://www.pea.co.th/business-partner/produt-acceptance)[[8]](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/)

หากผู้บริหารต้องการข้อเสนอเชิงนโยบายสั้นที่สุดในบรรทัดเดียว:  
**ควรอนุมัติให้เดินหน้าเฟสสำรวจและออกแบบละเอียดทันที แต่ยังไม่ควรอนุมัติงบก่อสร้างเต็มจำนวนจนกว่าจะได้โหลดจริง โครงสร้างจริง ข้อจำกัด utility จริง และใบเสนอราคาจริง** [1]

---

## เอกสารอ้างอิง

1. เอกสารขอบเขตงาน Solar Rooftop ที่ผู้ใช้แนบ (เอกสารต้นทางของผู้ว่าจ้าง)
2. [PEA - เอกสารอัตราค่าไฟฟ้า](https://www.pea.co.th/sites/default/files/documents/tariff/electricity_tariff.pdf) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
3. [PEA - อัตราค่าบริการต่าง ๆ](https://www.pea.co.th/our-services/tariff) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
4. [PEA PPIM - ระบบบริหารจัดการข้อมูลผู้ผลิตไฟฟ้าจากพลังงานทดแทน](https://ppim.pea.co.th/) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
5. [PEA PPIM - ขอเชื่อมต่อระบบผลิตไฟฟ้าสำหรับใช้เอง](https://ppim.pea.co.th/app/v2/emr/project/parallel/DG-SELF) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
6. [PVsyst Documentation](https://www.pvsyst.com/help/) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
7. [PVsyst - Array and System Losses](https://www.pvsyst.com/help/project-design/array-and-system-losses/index.html) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
8. [IEA PVPS Task 13 - Photovoltaic Project Decisions: Quality, Performance, and Economic Value](https://iea-pvps.org/key-topics/t13-pv-project-decisions-2026/) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
9. [IEA PVPS - Reliability and Performance of PV Systems](https://iea-pvps.org/research-tasks/reliability-and-performance-of-pv-systems/) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
10. [NREL - Comparative PV LCOE Calculator Documentation](https://www.nrel.gov/pv/lcoe-calculator/documentation.html) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
11. [PEA PPIM - รายการโครงการ/ตรวจสอบจุดเชื่อมโยง](https://ppim.pea.co.th/app/v1/project/list) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
12. [PEA Product Acceptance](https://www.pea.co.th/business-partner/produt-acceptance) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
13. [Developing a Thailand solar irradiance map using Himawari-8 satellite imageries and deep learning models](https://arxiv.org/abs/2409.16320) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
14. [PEA - ประกาศและข้อกำหนดเกี่ยวกับการเชื่อมต่อระบบโครงข่ายไฟฟ้า](https://www.pea.co.th/business-partner/regulation) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
15. [PEA PPIM - โครงการ Solar Rooftop](https://ppim.pea.co.th/app/v1/project/solar/list) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
16. [PEA - ข้อกำหนดการเชื่อมต่อระบบโครงข่ายไฟฟ้า](https://www.pea.co.th/business-partner/regulation) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
17. [PEA - ค่า Ft](https://www.pea.co.th/our-services/tariff/ft) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
18. [PEA Smart List](https://smartlist.pea.co.th/) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
19. [NREL - Photovoltaic Module Soiling Map](https://www.nrel.gov/pv/soiling.html) (เข้าถึงวันที่ 15 กรกฎาคม 2569)
