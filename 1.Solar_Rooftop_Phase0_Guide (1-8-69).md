...
| A-007 | ใช้ Phelps Dodge H1Z2Z2-K 1C 4/6/10/16 mm² เป็นตัวอย่าง PV containment screening | Rev.6 `Vendor Register` เป็น OD master ที่เชื่อม downstream; OD ที่ใช้คือ 6/7.0*/8.2/9.8 mm | ใช้คำนวณ physical area และทำ 0.8W single-layer cross-check เท่านั้น; cross-check ไม่มีผลต่อการใช้จริง; exact project cable, datasheet revision และ installation method ยัง HOLD | Owner / Lead Engineer | Screening only |
...
PV reference สำหรับ screening ของ Rev.6 คือ **Phelps Dodge H1Z2Z2-K** จาก OD master ใน `Vendor Register` โดยใช้ 1C 4/6/10/16 mm² และ OD screening 6/7.0*/8.2/9.8 mm ตามลำดับ. ใน wireway ให้นับพื้นที่วงกลมจาก OD ของสายแต่ละเส้น เดินขั้ว `+/-` ของ string เดียวกันร่วมกัน และตรวจ area fill ตามมาตรฐานแยกจาก width screen ซึ่งเป็นการตรวจเพิ่มเติมของโครงการ. ใน cable ladder/tray **ห้ามสรุปว่าวางได้เพียงเพราะ datasheet ผู้ผลิตระบุ tray**: เกณฑ์ทั่วไป วสท. 022001-22 ข้อ 5.15 อนุญาตสายแกนเดียวมีเปลือกวางตรงบนรางเมื่อขนาดตัวนำไม่น้อยกว่า 25 mm² ดังนั้น PV 1C 4/6/10/16 mm² ต้องใช้ท่อ/closed wireway/วิธีเดินสายที่ได้รับอนุมัติ หรือยืนยันข้อกำหนดเฉพาะจาก วสท. 022013-23 และ Lead Engineer ก่อน

> **หมายเหตุ OD ของสาย 6 mm²:** ค่า `7.0 mm*` ที่ใช้กับ Phelps Dodge H1Z2Z2-K 1C × 6 คือ **outside diameter (OD)** ไม่ใช่ CSA 7 mm²; ปรับจากค่า 6.5 mm เพื่อเผื่อ (conservative allowance) สำหรับการ screening. ต้องยืนยัน OD จาก datasheet/product code ที่อนุมัติจริงก่อน IFC
...
|---|---|---|---|---|---|---|---|---|---|
| PV-EX-4-WW | Phelps Dodge H1Z2Z2-K | 1C x 4 | 6.0 mm | 70 cables by 20% area; 13 cables by 0.8W single-layer cross-check | Wireway 100 x 100 mm internal | 10,000 mm² | 35 pairs by area; 6 pairs by cross-check | 20% normal section / วสท. 5.12; 0.8W is supplementary only | Area max = 19.79%; 0.8W cross-check = 78%; **no effect on actual use** |
| PV-EX-6-WW | Phelps Dodge H1Z2Z2-K | 1C x 6 | 7.0 mm* | 51 cables by 20% area; 11 cables by 0.8W single-layer cross-check | Wireway 100 x 100 mm internal | 10,000 mm² | 25 pairs by area; 5 pairs by cross-check | 20% normal section / วสท. 5.12; 0.8W is supplementary only | Area max = 19.63%; 0.8W cross-check = 77%; **no effect on actual use** |
| PV-EX-10-WW | Phelps Dodge H1Z2Z2-K | 1C x 10 | 8.2 mm | 37 cables by 20% area; 9 cables by 0.8W single-layer cross-check | Wireway 100 x 100 mm internal | 10,000 mm² | 18 pairs by area; 4 pairs by cross-check | 20% normal section / วสท. 5.12; 0.8W is supplementary only | Area max = 19.54%; 0.8W cross-check = 73.8%; **no effect on actual use** |
| PV-EX-16-WW | Phelps Dodge H1Z2Z2-K | 1C x 16 | 9.8 mm | 26 cables by 20% area; 8 cables by 0.8W single-layer cross-check | Wireway 100 x 100 mm internal | 10,000 mm² | 13 pairs by area; 4 pairs by cross-check | 20% normal section / วสท. 5.12; 0.8W is supplementary only | Area max = 19.61%; 0.8W cross-check = 78.4%; **no effect on actual use** |
...
<p align="center">
  <img src="./Fig.2.Ladder (GPT) การเดินสายไฟ.png" alt="รูปแบบการติดตั้งสายไฟบน Cable Ladder แยกตามประเภท" width="1000">
</p>
<p align="center"><em>Fig.2 — ตัวอย่างการจัดวางสายบน Cable Ladder/Tray และการแยกประเภทสาย</em></p>

<p align="center">
  <img src="./Fig.1.Ladder Trefoil ที่ถูกต้อง 2D-Web.png" alt="การจัดวางสาย 1C แบบ trefoil ที่ถูกต้องบน Cable Ladder" width="1000">
</p>
...
<p align="center">
  <img src="./Fig.3.Wireway (GPT) การติดตั้ง Installation.png" alt="ตัวอย่างการติดตั้งสายไฟใน Wireway พร้อมฝาปิดและจุดรองรับ" width="1000">
</p>
<p align="center"><em>Fig.3 — ตัวอย่างการติดตั้ง Wireway พร้อมฝาปิด, จุดรองรับ และภาพตัดขวาง</em></p>

<p align="center">
  <img src="./Fig.4.Wireway (GPT) การเดินสายไฟรวม.png" alt="ตัวอย่างการเดินสายไฟรวมใน Wireway โดยแยกประเภทด้วย partition" width="1000">
</p>
