...
สำหรับกรณีพื้นที่ประเทศไทย ไม่ควรสรุปว่า Tilt 0° ดีกว่า Tilt 10° จาก shading เพียงตัวเดียว

ควร run **สอง variant ด้วย TMY เดียวกัน**:
...
**ข้อสรุป preliminary:**  
Tilt 0° ชนะด้าน **mutual row shading** แต่ Tilt 10° มีข้อได้เปรียบด้าน **POA transposition, drainage/self-cleaning และ row density เล็กน้อย**. สำหรับประเทศไทย ค่า annual optimum tilt ที่รายงานในงานวิจัยอยู่ราว 10–15° ในหลายกรณี จึงควรให้ TMY/PVsyst เป็นตัวตัดสิน final layout ไม่ใช่ shading geometry เพียงอย่างเดียว
